...
def search(request):
    ...
    context = {
        ...
        'query': query,
        'suggestion': None,
        'all_objects':UserProfile.objects.filter(user__is_active = True, user__usersiteprofile__site=Site.objects.get_current() ).order_by('-user__reputation__reputation')
    }
